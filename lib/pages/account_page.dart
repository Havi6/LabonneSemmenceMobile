...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    final createdAt = _readUser('createdAt') ?? _readUser('created_at') ?? 'Non renseigne';
          ...
          child: Column(
            ...
            children: [
              ...
              if (_isLoading)
                ...
                _buildProfileCard([
                  _buildListTile("Nom du profil", name, Icons.person_outline),
                  _buildListTile("Date de création du compte", createdAt, Icons.lock_clock_outlined),
              ...
              _buildProfileCard([
                _buildListTile("Modifier le mot de passe", null, Icons.lock_outline),
                _buildListTile("Supprimer le compte", null, Icons.delete_outline, isDestructive: true),
              ]),
  ...
  Widget _buildListTile(String title, String? subtitle, IconData icon, {bool isDestructive = false}) {
    return ListTile(
